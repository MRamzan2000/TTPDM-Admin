...
import 'package:ttpdm_admin/controller/getx_controllers/mid_admin_notification_controller.dart';

class MidAdminNotiFicationScreen extends StatelessWidget {
  const MidAdminNotiFicationScreen({super.key});
