          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Container(
                  padding:
                      EdgeInsets.symmetric(horizontal: 2.7.h, vertical: 1.9.h),
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(2.h),
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: const CircularProgressIndicator(
                              ...
                              strokeWidth: 5,
                              valueColor:
                                  AlwaysStoppedAnimation(Color(0xffFFC542)),
                            ),
                          ),
                          SizedBox(
                            height: 16.7.h,
                            ...
                            child: const CircularProgressIndicator(
                              ...
                              strokeWidth: 5,
                              valueColor:
                                  AlwaysStoppedAnimation(Color(0xff0062FF)),
                            ),
                          ),
                          SizedBox(
                            height: 16.7.h,
                            ...
                            child: const CircularProgressIndicator(
                              ...
                              strokeWidth: 5,
                              valueColor:
                                  AlwaysStoppedAnimation(Color(0xff3DD598)),
                            ),
                          ),
                          Positioned(
                            bottom: 6.h,
