...
import 'package:ttpdm_admin/controller/getx_controllers/sign_up_controller.dart';
...
class RegisterScreen extends StatelessWidget {
  ...
  final RxBool midAdmin = false.obs;
  final RxBool superAdmin = false.obs;
  @override
  Widget build(BuildContext context) {
    final SignUpController signUpController =
        Get.put(SignUpController(context: context));
    return Scaffold(
                      ...
                      customElevatedButton(
                        ...
                        onTap: () {
                          ...
                          else if (!signUpController.isValidCanadianPhoneNumber(phoneNumber.text))
                          {
                            ...
                            signUpController.midAdminSignUp(
