...
class GetBusinessController extends GetxController{
  ...
  Rxn<GetBusinessByStatusModel?>pendingBusiness=Rxn<GetBusinessByStatusModel>();
  Rxn<GetBusinessByStatusModel?>approvedBusiness=Rxn<GetBusinessByStatusModel>();
...
final RxBool isLoading=true.obs;
  Future<void> fetchBusinessByStatus(
    ...
    final data = await BusinessApis().getBusinessByStatus(status: status, context: context);
    if (data != null) {
      status == "pending"
